...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { farm_id: @zone.farm_id, location: @zone.location, name: @zone.name, seed_id: @zone.seed_id } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { farm_id: @zone.farm_id, location: @zone.location, name: @zone.name, seed_id: @zone.seed_id } }
